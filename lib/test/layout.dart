...
class LayoutState extends State<LayoutWidget> with WidgetsBindingObserver {
  var ccc;
    ...
    return Wrap(
      ...
      children: <Widget>[
        ...
        Chip(
          label: Text("宝宝辅导费"),
          avatar:
              CircleAvatar(backgroundColor: Colors.black54, child: Text("B")),
        ),
        Chip(
          label: Text("次次次开关柜"),
          avatar:
              CircleAvatar(backgroundColor: Colors.black54, child: Text("C")),
        ),
        Chip(
          label: Text("d的高科技的考虑过"),
          avatar:
              CircleAvatar(backgroundColor: Colors.black54, child: Text("D")),
        ),
        Chip(
          label: Text("gdiandi"),
          avatar:
              CircleAvatar(backgroundColor: Colors.black54, child: Text("G")),
        )
      ],
    );
  }
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[Text("121fgfg32"), Text("4fgfgf")],
              ),
            ),
          ),
        ],
...
Widget get constrainBox {
  return ConstrainedBox(
    constraints: BoxConstraints(minWidth: 200, maxHeight: 20),
    child: Container(
      width: 50,
      height: 50,
      color: Colors.red,
...
class ListViewState extends State<ListViewWidget> with WidgetsBindingObserver {
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Image.asset("assets/ic_back.png", fit: BoxFit.cover),
            ),
          ),
          SliverToBoxAdapter(
            child: HomeBanner(banner, 200.0)
          ),
          SliverPadding(
